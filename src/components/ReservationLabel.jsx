    ...
    return (
        ...
        <div className='p-4 rounded-lg relative my-4' style={{backgroundColor: backgroundColor}}>
            <IoIosArrowDroprightCircle
                className='absolute right-4 top-1/2 transform -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 hover:scale-110 cursor-pointer'
                color='#426276'
                onClick={() => router.push(`/check-in-out?reservationId=${encodeURIComponent(reservation.reservationId)}`)}/>
