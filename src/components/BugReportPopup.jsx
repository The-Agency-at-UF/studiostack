...
function BugReportPopup({ userEmail }) {
    ...
    return (
        <Popup 
            ...
            modal 
            nested
            contentStyle={{ backgroundColor: '#ECECEC', borderRadius: '0.5rem', border: '2px solid black', width: '90%', maxWidth: '500px' }}  
            overlayStyle={{ backgroundColor: 'rgba(105, 105, 105, 0.5)', zIndex: 2000 }} 
        >
            {
                close => (
                    <div className='modal relative'>
                        <div className='content p-6'>
                            <h1 className='font-bold text-2xl pb-4 border-b border-black mb-4'>Report a Bug</h1>
