    ...
    return (
        <Popup trigger=
            {//look of the trigger depends on the type of action (from the input)
                ...
                wholeReservation ? <button className="absolute top-1 right-1 md:top-8 md:right-8 bg-[#A3C1E0] rounded-md text-base sm:text-xl font-bold p-1 sm:p-2 hover:cursor-pointer hover:scale-105">Cancel Reservation</button> :
                <div>
