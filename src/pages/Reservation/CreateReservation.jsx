    ...
    return (
        <div className='bg-white m-8 p-8 rounded-lg relative'>
            <div className='pl-2 pr-2'>
                ...
                {generalError && (
                    <div className="p-4 mb-4 rounded bg-red-100 text-red-800 border border-red-400">
                        {generalError}
                        <button onClick={() => setGeneralError('')} className="float-right font-bold">×</button>
                    </div>
                )}
                {successMessage && (
                    <div className="p-4 mb-4 rounded bg-green-100 text-green-800 border border-green-400">
                        {successMessage}
